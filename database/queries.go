...
func CreateRingtone(name string, category int, phones []int, effect int, authorID int, autoGenerated bool, glyphData string) (int, error) {
	var ringtoneID int
	err := DB.QueryRow(`INSERT INTO ringtone (name, category, effect_id, author_id, auto_generated, glyphs) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id;`, name, category, effect, authorID, autoGenerated, glyphData).Scan(&ringtoneID)
	if err != nil {
		return 0, err
	}
